...
Android相册选择工具，实现了拍照、图片选择（单选/多选）、图片载入方式无绑定 任由开发者选择
...
## ImagesPickers 关于ImagesPickers
Andorid-ImagesPickers是一个图片选择（单选/多选）、拍照、裁剪的图片选择器。使用方便，功能可自己配置，Andorid-ImagesPickers自身并没有强制绑定某个ImageLoader，开发者可以根据自己项目给Andorid-ImagesPickers配置图片加载器。<br><br>
